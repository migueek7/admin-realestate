            ...
            columns: [
                {
                    data:
                        function (data) {
                            ...
                            return `
                                <img src="${app.apirest_url}/public/images/users/${photo}" class="img-fluid" style="max-height: 50px"/>
                            `;
                        }
                },
                { data: 'name_user' },
    ...
    btnAction() {
        ...
        cardTable.addEventListener('click', (e) => {
            ...
            if (e.target.classList.contains('btnEliminar')) {
                ...
                this.delete.deleteRegister(idUser, e.target);
            }

            if (e.target.classList.contains('btnEditar')) {
                const idUser = e.target.getAttribute("iduser");
                e.target.disabled = true;
                this.update.getUser(idUser, e.target);

                let form = document.getElementById('addUserForm');
                this.update.saveUpdate(this.token, idUser, form);
