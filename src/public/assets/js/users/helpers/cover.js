...
export default class CoverHelper {
    ...
    //     this.rutas = this.modules.getRutas();
                ...
                if (imagen["type"] == "image/jpeg" ||
                    ...
                    respuestaFoto.innerHTML = `
                        <div class="alert alert-danger" role="alert">
                            ...
                            La imagen debe tener un formato JPG, JPEG, PNG o WEBP.
                        </div>
                    `;
                    return;
                }
                ...
                img.onload = function () {
                    ...
                    datosImagen.onload = function (event) {
                        ...
                        if (rutas[0] == 'update-property') {
                            ...
                            localStorage.setItem('photoUser', JSON.stringify(coverImage));
                        }
                    ...
                    const saveDataPortada = (coverImage) => {
                        ...
                        //let arrayData = JSON.parse(localStorage.getItem('cover'));
