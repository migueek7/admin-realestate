    ...
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body p-0" style="overflow: hidden;">
                ...
                <form id="addUserForm" method="post" class="form-row formUsuario needs-validation" data-original-data="" novalidate>
                    ...
                    <div class="col-lg-6 p-3 p-lg-5">
                        ...
                        <div class="form-group">
                            <label for="puestoUser">Puesto</label>

                            <input type="text" id="puestoUser" name="puesto" class="form-control" value="" required>
                            <p class="help-block"></p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="phoneUser" name="phone" class="form-control" value="" required>
                            <p class="help-block"></p>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="password" id="passwordUser" name="password" class="form-control" autocomplete="new-password">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control custom-select browser-default" id="rolUser" name="rol" required>
                                ...
                                <?php foreach ($data as $key => $value) : ?>
                                    <option value="<?= $value['id_rol'] ?>"><?= $value["name"]; ?></option>
                                <?php endforeach; ?>
                            </select>
                            <p class="help-block"></p>
                        </div>
                    ...
                    <div class="col-12 d-flex justify-content-center py-3 border-top">
                        <button type="button" class="btn btn-secondary" data-dismiss="modal">CANCELAR</button>
                        <button type="button" id="btnAddUser" class="btn btn-primary d-none">AGREGAR</button>
                        <button type="button" id="btnUpdateUser" class="btn btn-primary d-none">ACTUALIZAR</button>
                    </div>
